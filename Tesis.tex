...
\title{Reconocimiento de información textual alfanumérica grabada sobre superficies metálicas con bajo contraste mediante técnicas de visión por computadora.}
\author{Alan Martín Romo Aréchiga}
...
\begin{dedicatoria}
  \input{03_Dedicatoria}
\end{dedicatoria}

% Genera página de agradecimientos
\begin{agradecimientos}
  \input{04_Agradecimientos}
\end{agradecimientos}
